...
import 'package:flutter_getx_pattern/src/app/modules/blog/detail_blog/detail_blog_controller.dart';
...
class _DetailBlogPageState extends State<DetailBlogPage> {
  ...
  String timeAgo = Get.arguments[1];
  DetailBlogController _detailBlogController = Get.put(DetailBlogController());

  @override
  Widget build(BuildContext context) {
    return GetBuilder<DetailBlogController>(
        init: _detailBlogController,
        builder: (controller) {
          controller.getDataOfUser(blog.userId);
